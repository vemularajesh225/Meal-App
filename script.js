        ...
        html += `
          <div id="meal-details" class="mb-5">
            ...
            <div class="text-center">
              <a href="${data.meals[0].strYoutube}" target="_blank" class="btn btn-success mt-3">Watch Video</a>
              <a href="${data.meals[0].strSource}" target="_blank" class="btn btn-success mt-3">Read Article</a>
            </div>
          </div>
        `;
    });
